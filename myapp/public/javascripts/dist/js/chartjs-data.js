	...
	if( $('#chart_1').length > 0 ){
		...
		var data1 = {
			...
			datasets: [
			{
				...
				borderColor: "#f83f37",
				pointBorderColor: "#f83f37",
				pointHighlightStroke: "#f83f37",
				data: [0, 59, 80, 58, 20, 55, 40]
			},
			{
				label: "sec",
				backgroundColor: "#ab26aa",
				borderColor: "#ab26aa",
				pointBorderColor: "#ab26aa",
				pointBackgroundColor: "#ab26aa",
			...
			datasets: [
				{
					...
					backgroundColor: "#f83f37",
					borderColor: "#f83f37",
					pointBackgroundColor: "#f83f37",
					pointBorderColor: "#fff",
					pointHoverBackgroundColor: "#fff",
					pointHoverBorderColor: "#f83f37",
